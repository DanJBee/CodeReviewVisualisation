...
\section{Development of the crawl.py file}\label{sec:development-of-the-crawl.py-file}
...
\section{Formatting of the query string}\label{sec:formatting-of-the-query-string}
