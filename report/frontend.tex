...
\section{JavaScript vs TypeScript}\label{sec:javascript-vs-typescript}
...
\section{ESLint \& Prettier}\label{sec:eslint-&-prettier}
...
\section{Developer relationship algorithm}\label{sec:developer-relationship-algorithm}
...
\section{Applying D3.js}\label{sec:applying-d3.js}
