...
\begin{document}
    ...
    % Add visualisation final product screenshot later on
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Overall, the final, improved crawler file uses the requests pip library to make a callback to the GitHub GraphQL API,
